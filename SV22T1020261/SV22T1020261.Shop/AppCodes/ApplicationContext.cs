...
namespace SV22T1020261.Shop
{
    ...
    public static class ApplicationContext
    {
        ...
        /// <summary>
        /// Xóa dữ liệu trong session theo key
        /// </summary>
        /// <param name="key">Tên biến session cần xóa</param>
        ...
        /// <summary>
        /// Số dòng hiển thị trên một trang khi phân trang dữ liệu. Giá trị này được lấy từ appsettings.json
        /// </summary>
